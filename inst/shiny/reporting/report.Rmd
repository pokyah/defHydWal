...
data(wallonia.sp)
data(grid.250)
dh.spatial = dhw_idw(data = dhw_as.spatial(dhw_summary), param = "defExHyd", grid = grid.250)
ip.spatial = dhw_idw(data = dhw_as.spatial(dhw_summary), param = "ind_plu", grid = grid.250)
browser()
```
