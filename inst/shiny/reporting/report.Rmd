...
#browser()
if (as.Date(params$dto) > as.Date("2018-06-30")) {
...
# data(grid.grid)
data(wallonia.sp)
dh.spatial = dhw_idw(data = dhw_as.spatial(dhw_summary), param = "defExHyd", grid = as(dhw_grid(wallonia.sp, 250),
  "Spatial"))
ip.spatial = dhw_idw(data = dhw_as.spatial(dhw_summary), param = "ind_plu", grid = as(dhw_grid(wallonia.sp, 250),
  "Spatial"))
browser()
```
